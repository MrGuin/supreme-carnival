...
func (rf *Raft) AppendEntries(args *AppendEntriesArgs, reply *AppendEntriesReply) {
	...
	if args.PrevLogIndex >= len(rf.log) || // consistency check
		rf.log[args.PrevLogIndex] != nil && rf.log[args.PrevLogIndex].Term != args.PrevLogTerm {
